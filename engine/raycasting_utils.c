...
/*   Updated: 2020/11/02 17:16:40 by lpellier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		raycasting5(t_cub *cub)
{
	if (cub->ray.side == 0)
	{
		...
		cub->ray.tex_num = cub->ray.raydir_x > 0 ? 1 : 0;
	}
	else
	{
	...
	cub->ray.perp_wall_dist = cub->ray.perp_wall_dist < 0.001 ? \
	0.001 : cub->ray.perp_wall_dist;
